...
if __name__ == '__main__':
    ...
    best_mean1.save_weights(f"./HR/mean1_c4_ckpt")
    best_mean2.save_weights(f"./HR/mean2_c4_ckpt")
    best_mean3.save_weights(f"./HR/mean3_c4_ckpt")
    best_mean4.save_weights(f"./HR/mean4_c4_ckpt")

    last_loss1,last_loss2,last_loss3,test_cluster1,test_cluster2,test_cluster3,test_cluster4=evaluate(test_tensor,15,lr_val,eval_ker1,eval_mean1,eval_noise1,eval_ker2,eval_mean2,eval_noise2,eval_ker3,eval_mean3,eval_noise3,eval_ker4,eval_mean4,eval_noise4)
    
    with open(f'./HR/c4Cluster.txt', 'wb') as f:
    ...
    with open('./HR/c4Loss.txt', 'wb') as f:
